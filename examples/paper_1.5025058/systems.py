...
rho_dict = {
    name_lst[0]: {11: iterative_list.copy(),
                  12: iterative_list.copy(),
                  13: iterative_list.copy(),
                  14: iterative_list.copy(),
                  15: iterative_list.copy(),
                  16: iterative_list.copy(),
                  },
    name_lst[1]: {21: iterative_list.copy(),
                  22: iterative_list.copy(),
                  23: iterative_list.copy(),
                  24: iterative_list.copy(),
                  25: iterative_list.copy(),
                  26: iterative_list.copy(),
                  },
    name_lst[2]: {31: iterative_list.copy(),
                  32: iterative_list.copy(),
                  33: iterative_list.copy(),
                  34: iterative_list.copy(),
                  35: iterative_list.copy(),
                  36: iterative_list.copy(),
                  },
    name_lst[3]: {41: iterative_jahn_teller_list.copy(),
                  42: iterative_jahn_teller_list.copy(),
                  43: iterative_jahn_teller_list.copy(),
                  44: iterative_jahn_teller_list.copy(),
                  45: iterative_jahn_teller_list.copy(),
                  46: iterative_jahn_teller_list.copy(),
                  },
}
