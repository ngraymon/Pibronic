...
SOS_SCRIPT="$SLURM_SUBMIT_DIR/workspace/fast_hacked.exe";
...
echo ${SOS_SCRIPT} "-SH" ${BASIS_SIZE} ${SURFACES} ${MODES} ${NUM_OF_TEMPS} ${DATA_SET_ID}
# execute the job
...
mv --force ${SCRATCH_DIR}/ho_eig_B${BASIS_SIZE}.txt ${ROOT_DIR}parameters/
mv --force ${SCRATCH_DIR}/ho_eigvect_B${BASIS_SIZE}.txt ${ROOT_DIR}parameters/
